	...
	public class PrecomputedMoveData {
		...
		static {
			...
			for (int squareIndex = 0; squareIndex < 64; squareIndex++) {
				...
				var legalKnightJumps = new LinkedList<Byte>();
                ...
                // save legalKnightJumps at knightMoves[squareIndex] 
                knightMoves[squareIndex] = new byte[legalKnightJumps.size()];
                for (int i = 0; i < legalKnightJumps.size(); i++) {
                    knightMoves[squareIndex][i] = legalKnightJumps.get(i);
                }
				...
				var legalKingMoves = new LinkedList<Byte> ();
				...
				kingMoves[squareIndex] = new byte[legalKingMoves.size()];
                for (int i = 0; i < legalKingMoves.size(); i++) {
                    kingMoves[squareIndex][i] = legalKingMoves.get(i);
                }

				// Calculate legal pawn captures for white and black
				List<Integer> pawnCapturesWhite = new LinkedList<Integer> ();
				List<Integer> pawnCapturesBlack = new LinkedList<Integer> ();
